...
import (
	...
	v1alpha1 "github.com/SAP/cloud-robotics/src/go/pkg/client/listers/config/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigV1alpha1().Tenants().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigV1alpha1().Tenants().Watch(context.TODO(), options)
			},
		},
		&configv1alpha1.Tenant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configv1alpha1.Tenant{}, f.defaultInformer)
}
