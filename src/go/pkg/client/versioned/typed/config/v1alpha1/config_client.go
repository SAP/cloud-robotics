...
// ConfigV1alpha1Client is used to interact with features provided by the config.cloudrobotics.com group.
type ConfigV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigV1alpha1Client) Tenants() TenantInterface {
	return newTenants(c)
}
