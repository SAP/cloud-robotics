# Contributing to ewm-cloud-robotics-s4
...
Go to [the Github issue tracker](https://github.com/SAP/ewm-cloud-robotics/issues?state=open) and find an open issue which needs additional work or a bugfix. Maybe you can even find and [contribute](#contribute-code) a bugfix?
...
When you contribute (code, documentation, or anything else), you have to be aware that your contribution is covered by the same [Apache 2.0 License](http://www.apache.org/licenses/LICENSE-2.0) that is applied to ewm-cloud-robotics itself.
